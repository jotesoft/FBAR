...
.field private mLifecycleOwner:Landroid/arch/lifecycle/f;
...
.method markForRedelivery()V
    ...
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLifecycleOwner:Landroid/arch/lifecycle/f;
    ...
    invoke-super {p0, v1}, Landroid/arch/lifecycle/LiveData;->removeObserver(Landroid/arch/lifecycle/n;)V

    invoke-virtual {p0, v0, v1}, Landroid/arch/lifecycle/LiveData;->observe(Landroid/arch/lifecycle/f;Landroid/arch/lifecycle/n;)V
...
.method public onLoadComplete(Landroid/support/v4/content/Loader;Ljava/lang/Object;)V
    ...
    :cond_2
    invoke-virtual {p0, p2}, Landroid/arch/lifecycle/m;->postValue(Ljava/lang/Object;)V
...
.method public removeObserver(Landroid/arch/lifecycle/n;)V
    ...
    invoke-super {p0, p1}, Landroid/arch/lifecycle/LiveData;->removeObserver(Landroid/arch/lifecycle/n;)V

    const/4 p1, 0x0

    iput-object p1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLifecycleOwner:Landroid/arch/lifecycle/f;
...
.method setCallback(Landroid/arch/lifecycle/f;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/content/Loader;
    .locals 2
    ...
    invoke-virtual {p0, p1, v0}, Landroid/arch/lifecycle/LiveData;->observe(Landroid/arch/lifecycle/f;Landroid/arch/lifecycle/n;)V

    iget-object p2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mObserver:Landroid/support/v4/app/LoaderManagerImpl$LoaderObserver;

    if-eqz p2, :cond_0

    invoke-virtual {p0, p2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->removeObserver(Landroid/arch/lifecycle/n;)V
